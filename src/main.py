...
parser.add_argument('--num_blocks', type=int, default=4, help='Number of denoised decoder blocks')
...
parser.add_argument('--dif_decoder', type=str, default='att',choices=['att', 'mlp'], help='Choose denoised decoder')
parser.add_argument('--split_onebyone', type=bool, default=False, help='Split sequence one by one')
parser.add_argument('--per_token_ag', type=bool, default=False, help='Train in a per token auto-aggressive manner')
